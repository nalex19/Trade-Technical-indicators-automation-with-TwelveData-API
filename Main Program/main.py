...
def check_cross() -> None:
    ...
    if recent_up.any() or recent_down.any():
        ...
        for ts_utc in recent_up[recent_up].index:
            ...
            EmailSender('test@.com').send_gmail('test@.com',f'Bullish: {SYMBOL}, Interval: {INTERVAL}', message_Bullish)
        ...
        for ts_utc in recent_down[recent_down].index:
            ...
            #EmailSender('test@.com').send_gmail('test@.com',f'Bearish: {SYMBOL}, Interval: {INTERVAL}', message_Bearish)
